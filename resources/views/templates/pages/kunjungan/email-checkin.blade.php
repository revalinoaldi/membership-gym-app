                                                    ...
                                                    <tr>
                                                        <td width="560" class="es-m-p0r" valign="top" align="center">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                <tr>
                                                                    <td align="center" class="es-p10b" style="font-size: 0px">
                                                                        <amp-img src="https://ssvcph.stripocdn.email/content/guids/CABINET_9ceb51ee6e7f30126356fdf31753de2cf875fb8de6239036c1b79db61b915e05/images/logo.png" alt="Logo" style="display:block;font-size:12px" width="200" title="Logo" height="122"></amp-img>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                            ...
                            <tr>
                                <td align="center">
                                    <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" class="es-p10t es-p10b" style="font-size: 0px">
                                                                        <amp-img class="adapt-img" src="https://ssvcph.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/90511617967234268.png" alt="" style="display: block" width="300" height="300" layout="responsive"></amp-img>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="es-p20t es-p5b es-m-txt-c">
                                                                        <h1>Successful Checkin Dayin</h1>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <tr>
                                            <td class="es-p20t es-p5b es-p20r es-p20l esdev-adapt-off" align="left">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tr>
                                                                    <td width="49" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="center" class="es-m-txt-c" style="font-size: 0px">
                                                                                    <amp-img src="https://ssvcph.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/50431617957498582.png" alt="" style="display: block" width="25" height="25"></amp-img>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                                <tr>
                                                                    <td width="501" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="left" class="es-p5b es-m-txt-l">
                                                                                    <h3>{{ $date." ".$time }}</h3>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                        ...
                                        <tr>
                                            <td class="es-p10t es-p5b es-p20r es-p20l esdev-adapt-off" align="left">
                                                <table width="560" cellpadding="0" cellspacing="0" class="esdev-mso-table">
                                                    <tr>
                                                        <td class="esdev-mso-td" valign="top">
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tr>
                                                                    <td width="49" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="center" class="es-m-txt-c" style="font-size: 0px">
                                                                                    <amp-img src="https://ssvcph.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/80951617957498354.png" alt="" style="display: block" width="25" height="25"></amp-img>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="501" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td align="left" class="es-p5b es-m-txt-l">
                                                                                    <h3>{{ $kunjungan->membership->kode_member.' - '.$kunjungan->membership->nama_lengkap }}</h3>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" role="presentation">
                                                                            <tr>
                                                                                <td align="center" valign="top" class="es-p40r">
                                                                                    <amp-img title="Facebook" src="https://ssvcph.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" height="32"></amp-img>
                                                                                </td>
                                                                                <td align="center" valign="top" class="es-p40r">
                                                                                    <amp-img title="X.com" src="https://ssvcph.stripocdn.email/content/assets/img/social-icons/logo-black/x-logo-black.png" alt="X" width="32" height="32"></amp-img>
                                                                                </td>
                                                                                <td align="center" valign="top" class="es-p40r">
                                                                                    <amp-img title="Instagram" src="https://ssvcph.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32" height="32"></amp-img>
                                                                                </td>
                                                                                <td align="center" valign="top">
                                                                                    <amp-img title="Youtube" src="https://ssvcph.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32" height="32"></amp-img>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="es-p35b">
                                                                        <p>Natural Fitness Center&nbsp;© 2023 Natural Fitness Center, Inc. All Rights Reserved.</p>
                                                                        <p>Jl. Pangeran Sogiri Ruko No.488, RT.001/RW.001, Tanah Baru,<br>Kec. Bogor Utara, Kota Bogor, Jawa Barat 16154</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="0" width="100%" class="es-menu" role="presentation">
                                                                            <tr class="links">
                                                                                <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top: 5px;padding-bottom: 5px"><a target="_blank" href="#">Visit Us </a></td>
                                                                                <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top: 5px;padding-bottom: 5px;border-left: 1px solid #cccccc"><a target="_blank" href="#">Privacy Policy</a></td>
                                                                                <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-top: 5px;padding-bottom: 5px;border-left: 1px solid #cccccc"><a target="_blank" href="#">Terms of Use</a></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
