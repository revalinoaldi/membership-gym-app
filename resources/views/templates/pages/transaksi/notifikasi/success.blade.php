                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                <tr>
                                                                    <td align="center" class="es-p10t es-p10b" style="font-size: 0px">
                                                                        <amp-img src="https://ssvcph.stripocdn.email/content/guids/CABINET_c0e87147643dfd412738cb6184109942/images/151618429860259.png" alt="" style="display: block" width="100" height="100"></amp-img>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="es-p10b es-m-txt-c">
                                                                        <h1 style="font-size: 46px;line-height: 46px">Successfully Payment Membership!</h1>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                <tr>
                                                                    <td align="center" class="es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l">
                                                                        <p>Your Payment has now been completed! <br>We’ve attached your <strong>receipt </strong>to this email.</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="es-p10t es-p10b"><span class="es-button-border"><a href="{{ $url }}" class="es-button" target="_blank">View Invoice</a></span></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
