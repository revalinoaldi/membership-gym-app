        ...
        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('admin/') }}/images/logo.svg" alt="image" />
                    <span
                    ...
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span
                            ><img
                                ...
                                src="{{ asset('admin/') }}/images/user-profile.jpeg"
                                alt="image"
                        /></span>
                    </a>
                    <ul
                    ...
                    >
                        <li>
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('admin/') }}/images/user-profile.jpeg" alt="image" />
                                </div>
