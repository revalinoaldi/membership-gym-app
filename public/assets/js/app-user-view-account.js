$(function() {
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, s) {
                var n = a.project_name,
                    i = a.framework,
                    l = a.project_image;
                return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar avatar-sm me-3">' + (l ? '<img src="' + assetsPath + "img/icons/brands/" + l + '" alt="Project Image" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random()) + 1] + '">' + (l = (((l = (n = a.full_name).match(/\b\w/g) || []).shift() || "") + (l.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="text-truncate fw-medium">' + n + '</span><small class="text-muted">' + i + "</small></div></div>"
            }
        }, {
            targets: 2,
            orderable: !1
            ...
            render: function(e, t, a, s) {
                ...
                return '<div class="d-flex flex-column"><small class="mb-1">' + i + '</small><div class="progress w-100 me-3" style="height: 6px;"><div class="progress-bar ' + n + '" style="width: ' + i + '" aria-valuenow="' + i + '" aria-valuemin="0" aria-valuemax="100"></div></div></div>'
            }
        }, {
            targets: -1,
            orderable: !1
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, s) {
                var n = a.invoice_status,
                    i = a.due_date;
                return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + n + '<br> <span class="fw-medium">Balance:</span> ' + a.balance + '<br> <span class="fw-medium">Due Date:</span> ' + i + "</span>'>" + {
    ...
    invoiceTable.length && invoiceTable.DataTable({
        scrollX: true,
        dom: '<"row mx-4"<"col-sm-6 col-12 d-flex align-items-center justify-content-center justify-content-sm-start mb-3 mb-md-0"l><"col-sm-6 col-12 d-flex align-items-center justify-content-center justify-content-sm-end"B>>t<"row mx-4"<"col-md-12 col-lg-6 text-center text-lg-start pb-md-2 pb-lg-0"i><"col-md-12 col-lg-6 d-flex justify-content-center justify-content-lg-end"p>>',
        order: [
            [1, "desc"]
